...
class pdu_frame_format_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pdu_frame_format_test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pdu_frame_format_test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pdu_frame_format_test")
        ...
        self.chat_modem_pdu_frame_format_0 = chat_modem.pdu_frame_format(64, 114)
        self.chat_modem_pdu_char_to_ascii_0_0 = chat_modem.pdu_char_to_ascii(64-8)
        self.chat_modem_pdu_char_to_ascii_0 = chat_modem.pdu_char_to_ascii(64-8)
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern(chr(170)), 250)
        ...
        self.msg_connect((self.chat_modem_pdu_frame_format_0, 'msg_out'), (self.blocks_message_debug_0, 'print_pdu'))
...
def main(top_block_cls=pdu_frame_format_test, options=None):
