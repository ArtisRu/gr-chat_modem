...
class QPSK_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "QPSK_sim")
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4, 2*3.14/100, rrc_taps, 32, 16, 1.5, 2)
        self.digital_map_bb_0 = digital.map_bb([0,1,2,3])
        self.digital_diff_decoder_bb_0 = digital.diff_decoder_bb(4)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(2*3.14/100, 4, False)
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_bb('1110010', 0, 'sync_word')
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/artis/Downloads/simple_modem_random_plus_13syncw.bin', True, 0, 0)
