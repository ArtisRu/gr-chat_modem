...
class pdu_char_to_ascii_example(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pdu_char_to_ascii_example")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pdu_char_to_ascii_example")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pdu_char_to_ascii_example")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/artis/Desktop/pdu_char2ascii.bin', False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.chat_modem_pdu_char_to_ascii_0, 'msg_out'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))
...
def main(top_block_cls=pdu_char_to_ascii_example, options=None):
